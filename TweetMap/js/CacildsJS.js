...
CACILDS.Sprite.prototype.constructor=CACILDS.Sprite;CACILDS.Input=function(){CACILDS.Display.call(this);this.dom=document.createElement("div");this.dom.parent=this;this.input=document.createElement("input");this.dom.appendChild(this.input)};CACILDS.Input.prototype=new CACILDS.Display;CACILDS.Input.prototype.constructor=CACILDS.Input;CACILDS.Input.prototype.value=function(a){if(a)this.input.value=a;return this.input.value};
