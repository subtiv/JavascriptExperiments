...
CACILDS.Sprite.prototype.constructor=CACILDS.Sprite;CACILDS.Input=function(a){CACILDS.Display.call(this);this.dom=document.createElement("div");this.dom.parent=this;this.input=document.createElement("input");this.input.type=a||"text";this.dom.appendChild(this.input)};CACILDS.Input.prototype=new CACILDS.Display;CACILDS.Input.prototype.constructor=CACILDS.Input;
CACILDS.Input.prototype.value=function(a){var b=this.type()=="checkbox"||this.type()=="radio"?this.input.checked:this.input.value;if(a)this.type()=="checkbox"||this.type()=="radio"?this.input.checked=a:this.input.value=a;else return b;return b=this.type()=="checkbox"||this.type()=="radio"?this.input.checked:this.input.value};CACILDS.Input.prototype.type=function(a){if(a)this.input.type=a;return this.input.type};
CACILDS.Stage=function(){CACILDS.Display.call(this);this.dom=document.getElementsByTagName("body")[0];this.dom.parent=this};CACILDS.Stage.prototype=new CACILDS.Display;CACILDS.Stage.prototype.constructor=CACILDS.Stage;
